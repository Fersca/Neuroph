...
public class PruebaUno {
	...
	public static void main(String[] args) throws Exception {
		...
		String colorAuto = p1.detectColors(foto,true);
		
	    File file1 = new File("/home/fersca/coloresUnAuto.txt");
	    Writer output = new BufferedWriter(new FileWriter(file1));
		output.write(colorAuto+"0,0,0,0,0,0,0");
		output.close();	    

		DataSet trainingSet = DataSet.createFromFile("/home/fersca/coloresUnAuto.txt", 300, 7, ",");
		
        //NeuralNetwork loadedMlPerceptron = NeuralNetwork.load("myMlPerceptron.nnet");
		//NeuralNetwork loadedMlPerceptron = NeuralNetwork.load("myMlPerceptronCentro.nnet");
	...
	public String detectColors(String foto, Boolean isURL) throws Exception {
